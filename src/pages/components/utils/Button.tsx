...
const ButtonFC: FC<{ text: string, extendClassName: string, onClick: () => void }> = ({ text = "util-button", onClick = () => { }, extendClassName = "" }) => {
    return <div className={`flex items-center justify-between ${extendClassName}`}>
        <button
